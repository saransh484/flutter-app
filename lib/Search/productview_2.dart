...
class Product {
  ...
  Product({required this.name, required this.range});
}
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  selectedProducts
                      .add(Product(name: name, range: _rating.toString()));

                  // Store the selected products in the Hive box
                  await _shoppingBox.put('selectedProducts', selectedProducts);
                },
